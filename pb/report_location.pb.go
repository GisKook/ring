...
func (*WifiCell) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{0} }
...
func (*StationCell) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{1} }
...
func (*LocationInfo) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{2} }
...
func (*ReportLocation) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{3} }
...
func init() { proto.RegisterFile("report_location.proto", fileDescriptor8) }
